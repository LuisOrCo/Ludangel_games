    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-7 px-6 py-12 sm:px-8 sm:py-16">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <button
          type="button"
          onClick={abrirCrear}
          className="rounded-xl bg-gradient-to-r from-[#06b6d4] to-[#0284c7] px-5 py-3 text-sm font-bold text-slate-950 shadow-lg shadow-cyan-500/20 transition-transform hover:-translate-y-0.5"
        >
          + Crear usuario
        </button>
      </div>
        ...
        <table className="w-full min-w-[850px] text-left text-sm">
          ...
          <tbody className="divide-y divide-slate-800">
            {cargando ? (
              ...
              <tr><td colSpan="5" className="px-5 py-10 text-center text-slate-400">No hay usuarios registrados.</td></tr>
